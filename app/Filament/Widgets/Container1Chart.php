...
class Container1Chart extends ChartWidget
{
    protected static ?string $heading = 'Contenedor Principal';
    ...
    {
        // Obtener lecturas de los últimos 7 días para el contenedor 1
